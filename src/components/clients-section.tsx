...
export const ClientsSection = () => {
    return (
        <section id="clients" className="mt-auto">
            <div className="max-w-full bg-black">
                <div className="container mx-auto px-4 py-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-30 items-start xl:w-10/12 xl:mx-auto">
                        <div>
                            <p className="text-lg leading-relaxed text-white pb-10">
                                This is a portfolio website created by Syafi Athar Aidan, showcasing his skills and
                                projects
                                in web development.
                                Designed & built with love using HTML, Tailwind CSS, and JavaScript.
                            </p>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            <div className="text-white">
                                ...
                                <ul className="mt-3 space-y-2">
                                    <li>
                                        <a href="#" className="inline-block font-medium text-[#808080] hover:text-white">
                                            +60104330331
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div className="text-[#808080]">
                                <h3 className="text-xl text-white font-semibold tracking-wide">SOCIALS</h3>
                                <div className="mt-4 grid grid-cols-4 gap-4">
                                    <a href="https://www.instagram.com/atharaidann" target="_blank"
                                        className="w-10 h-10 inline-flex items-center justify-center rounded-full hover:bg-white/10 hover:text-white transition">
                                        <svg role="img" width="28" height="28" viewBox="0 0 24 24" fill="currentColor"
                                    ...
                                    <a href="https://www.linkedin.com/in/syafi-athar-aidan-7a1664263/" target="_blank"
                                        className="w-10 h-10 inline-flex items-center justify-center rounded-full hover:bg-white/10 hover:text-white transition">
                                        <svg role="img" width="35" height="35" viewBox="0 0 24 24" fill="currentColor"
                                            className="inline" xmlns="http://www.w3.org/2000/svg">
                                            <path
                ...
                <div className="border-t border-white/10">
                    <div className="container mx-auto px-4 py-6 flex items-center justify-between">
                        <div className="flex items-center gap-3 xl:w-10/12 xl:mx-auto">
                            <Image src={AV} alt="AV" className="w-10 h-10 "/>
                            <p className="text-sm lg:text-lg text-neutral-200">
                                © 2025 SYAFI ATHAR AIDAN
                            </p>
                        </div>
                    </div>
                </div>
